...
import { BellIcon,MessageCircleMore, PlusIcon, SearchIcon } from "lucide-react"
        ...
        <div className="h-15 flex itmes-center justify-around px-3">
          <div className="flex items-center justify-start ">
             ...
             <span onClick={()=>{navigate('/homepage')
              ...
              } className="text-white text-3xl font-bold px-2 cursor-pointer">CodeBuzz</span>
          </div>
          <div className="w-full flex items-center">
              <div className="w-full flex items-center px-40">
                   <div className="bg-neutral-600 flex items-center gap-2 m-3 rounded-full px-3 py-2 w-110 ">
                      ...
                      <input type="text" placeholder="Search CodeBuzz " className="text-white px-1 w-full outline-none rounded-full placeholder:text-md  "></input>
                    </div>
              </div>      
          </div>

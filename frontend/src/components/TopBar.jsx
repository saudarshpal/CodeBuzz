      ...
      <header className="border-0 border-b border-neutral-700 px-md ">
        <div className="h-15 flex itmes-center px-3">
          ...
          <div className="w-full flex items-center">
              <div className="w-full flex items-center px-40">
                   <div className="bg-neutral-600 flex items-center gap-2 m-3 rounded-full px-3 py-2 w-110 ">
                      ...
                      <input type="text" placeholder="Search RimSide " className="px-1 w-full outline-none rounded-full placeholder:text-md placeholder : text-neutral-300 "></input>
                    </div>
              </div>      
          </div>
          <div className="flex items-center gap-2 ">
             ...
             <div className="bg-neutral-600 flex items-center gap-1 px-3 py-1 rounded-full cursor-pointer">
                  <span className="text-white text-lg font-medium">Create</span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
